...
<main role="main">
    ...
    <div class="container">
        ...
        <a href="AdicionarCor.php" class="btn btn-success">Adicionar Cores</a>
                ...
                <?php if ($colors): ?>
                    <?php foreach ($colors as $color): ?>
                        <tr>
                            ...
                            <td><a href="editarcor.php?id=<?= $color->id ?>" data-toggle="tooltip"
                                   title="Editar"><i class="bi bi-file-earmark-text"></i></a>
                                <a href="deletarcor.php?id=<?= $color->id ?>" data-toggle="tooltip"
